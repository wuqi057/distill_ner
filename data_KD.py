...
class Label:
    ...
    def __init__(self, value:str, score: np.float16 = 1.0): #NOTE: change for KD
        self.value = value
        self.score = score
        super().__init__()
    ...
    def score(self, score):
        if 0.0 <= score <= 1.0: #NOTE: change for KD
            self._score = score
        else:
            self._score = np.float16(1.0) #NOTE: change for KD
...
# class LabeledString(DataPoint): #NOTE: added new class
...
class Sentence(DataPoint):
    ...
    def __init__(
            ...
            start_position: int = None,
            logits = None, #NOTE: added additional pretrained logits information
            _position_in_dataset = None, #NOTE: added attribute
    ):
        """
        ...
        """
        super().__init__()
        self.logits = logits #NOTE: logits
        ...
        self._position_in_dataset = _position_in_dataset 
